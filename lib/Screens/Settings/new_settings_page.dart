...
import 'package:orbit/Screens/Settings/about.dart';
import 'package:orbit/Screens/Settings/app_ui.dart';
import 'package:orbit/Screens/Settings/backup_and_restore.dart';
import 'package:orbit/Screens/Settings/download.dart';
import 'package:orbit/Screens/Settings/music_playback.dart';
import 'package:orbit/Screens/Settings/others.dart';
import 'package:orbit/Screens/Settings/theme.dart';
...
class NewSettingsPage extends StatefulWidget {
  ...
  const NewSettingsPage({this.callback, this.scaffoldKey});
...
class _NewSettingsPageState extends State<NewSettingsPage>
  ...
  final List sectionsToShow = Hive.box('settings').get(
    'sectionsToShow',
    defaultValue: ['Home', 'Top Charts', 'Library'],
  ) as List;
