...
import 'package:orbit/CustomWidgets/bouncy_playlist_header_scroll_view.dart';
...
import 'package:orbit/CustomWidgets/playlist_popupmenu.dart';
                ...
                sliverList: SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      ...
                      final entry = songList[index - 1] as Map;
                      return ListTile(
                    ...
                    childCount: songList.isEmpty ? 0 : songList.length + 1,
                  ),
                ),
              ),
      ),
